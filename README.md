...
SEND_CDD_REQUEST_ERROR | There is an unexpected error(s) when you send CDD request to the originator VASP. Please refer to the error message. | Beneficiary VASP | No | 99999 | 
SEND_TRANSACTION_CDD_ERROR | There is an unexpected error(s) when you send enhanced CDD information to the beneficiary VASP. Please refer to the error message. | Originator VASP | No | 03055 99999 | 
